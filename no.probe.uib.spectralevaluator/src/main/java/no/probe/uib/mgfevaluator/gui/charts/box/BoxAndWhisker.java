 ...
 */
package no.probe.uib.mgfevaluator.gui.charts.box;
...
import static smile.data.CategoricalEncoder.values;
...
//    }
    public BoxAndWhisker(Map<String, double[]> inputData, final String title) {
...
//    }
     ...
     * @return The dataset.
     */
    private BoxAndWhiskerCategoryDataset createDataset(Map<String, double[]> inputDat, String title) {

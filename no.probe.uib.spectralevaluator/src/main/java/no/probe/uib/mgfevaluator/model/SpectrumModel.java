...
public class SpectrumModel implements Comparable<SpectrumModel> {
    ...
    private double avgSequenceLength;
     ...
     private double peaksIntensityRatio;
     private double generalSNR;
    ...
    public double getPeaksIntensityRatio() {
        return peaksIntensityRatio;
    }

    public void setPeaksIntensityRatio(double peaksIntensityRatio) {
        this.peaksIntensityRatio = peaksIntensityRatio;
    }

    public double getGeneralSNR() {
        return generalSNR;
    }

    public void setGeneralSNR(double generalSNR) {
        this.generalSNR = generalSNR;
    }
}
